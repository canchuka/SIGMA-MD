...
global.owner = process.env.OWNER_NUMBER  || '94719339207' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "94719339207" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '19_04_2024_SIGMA_MD_jqFCJuZi_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'ROOKU-BOT',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ROOKU`, // ADD YOUR NAME
